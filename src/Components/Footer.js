    ...
    return (
        <footer style={footerStyle}>
            ...
            <Grid container >
                <Grid item xs={12} lg={6}>
                    <Box ml={-20} mt={5} >
                        ...
                        <Box textAlign='center'>
                            <Typography variant='h3'>Business Name</Typography><br />
                            <Typography variant='h4'>New Delhi</Typography>
                            <Typography mt={2} ml={-15}><b> 2023 Example@gmail.com</b></Typography>
                        </Box>
                ...
                <Grid item xs={12} lg={6} >
                    <Box sx={{ fontFamily: buttonStyles.fontFamily, display:'flex', justifyContent:'end' }} mt={10} mx={2} >
                        <Box>
