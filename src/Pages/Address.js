...
export default function Address() {
    ...
    return (
        <Container sx={{ marginTop: '20px' }}>
            ...
            <Button fullWidth onClick={handleClickOpen} variant='outlined' sx={{ mx: 0, my: 2 }}>Add Address <AddIcon /> </Button>
            <Button fullWidth onClick={() => navigate('/schedule')} variant='contained' sx={{ mx: 0, my: 2 }}>Proceed</Button>
